...
@section('content')
    <div class="container">
        ...
        <form action="/user/update_user_name" method="POST">
        @csrf
        ...
        <hr>
        <br>
        <form action="/user/update_user_email" method="POST">
        @csrf
        ...
        <hr>
        <br>
        <form action="/user/reset_user_pw" method="POST">
        @csrf
        ...
        @if(auth()->user()->mod)
            ...
            <hr>
            <br>
            <p style="display:inline-block" href="/user/quit_moderation" 
        ...
        <hr>
        <br>
        <p style="display:inline-block" href="/user/delete_user" 
...
<script>
    function confirmQuitMod()
    {
        ...
        if(conf==true)
        {
            location.replace("/user/quit_moderation");
        }  
    }
    ...
    function confirm_delete_user()
    {
        ...
        if(conf==true)
        {
            location.replace("/user/delete_user");
        }  
    }
</script>